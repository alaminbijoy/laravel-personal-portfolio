                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="{{route('mailOutBox')}}"><i class="fa fa-envelope-o"></i> Sent</a></li>
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="{{ URL::to('/mail-outbox-read/'.$message->id) }}">To: {{$message->email}}</a></td>
...
@endsection
@section('script')
    <script src="{{ asset('admin_dist/plugins/iCheck/icheck.min.js') }}"></script>
    <script>
        $(function () {
