...
@section('contentHeader', 'Add New Portfolio')
                    ...
                    <form method="POST" action="{{ route('newPortfolio') }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="post_title" name="portfolio_title" placeholder="Add portfolio title" autofocus>
                            </div>
                            <div class="form-group">
